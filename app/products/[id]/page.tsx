...
export default function EditProductPage() {
  ...
  useEffect(() => {
    ...
    if (formData.category) fetchStores();
  }, [formData.category]);
  ...
  if (success) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
        ...
        <h2 className="text-3xl font-bold text-foreground font-mont">Product Updated!</h2>
        <p className="mt-2 text-muted text-lg">
          The product has been successfully updated in the store catalog.
        </p>
    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground font-mont">Edit Product</h1>
            <p className="text-sm text-muted">Update product details, pricing and inventory.</p>
          </div>
        </div>
        <button 
